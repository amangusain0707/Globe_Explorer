      ...
      {loading ? (
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.7rem', color: 'var(--muted)', marginTop: '0.4rem', letterSpacing: '0.1em' }}>
              {data.timezone}
            </div>
          </div>
          ...
          {currencyCode && currencyCode !== 'INR' && (
            <div style={{
              ...
              <p style={{ fontSize: '0.65rem', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--muted)', marginBottom: '0.6rem' }}>
                Convert INR → {currencyCode}
              </p>
              ...
              {converted && (
                <div style={{ marginTop: '0.6rem' }}>
                  <div style={{ fontFamily: 'var(--font-display)', fontSize: '1.4rem', fontWeight: '700', color: 'var(--gold)' }}>
                    {converted.result} {converted.code}
                  </div>
                  <div style={{ fontSize: '0.7rem', color: 'var(--muted)', marginTop: '0.2rem' }}>
                    1 INR = {converted.rate} {converted.code}
                  </div>
                </div>
              )}
            </div>
